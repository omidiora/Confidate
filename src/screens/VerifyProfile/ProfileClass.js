...
// import image_cam from '../../../assets/images/image_cam.png';
const client_id =
  'c052ec267c522adf2f1e2406f566d4d93e35db7fb34dff4972392011b9ddf5a6';
const secret_key = 'wTmcomfLxSmZZXSE3ksoFGgkSzb6bOkR';
...
const face_icon = '../../../assets/images/face.png';
const image_cam = '../../../assets/images/imageCam.png';
const video_cam = '../../../assets/images/videoCam.png';
const second_screen_icon = '../../../assets/images/select_type_icon.png';
const continue_next = '../../../assets/images/continue_next.png';
  ...
  constructor(props) {
    ...
    this.state = {
      paylaod: {
        ...
        email: '',
        callback_url:
          'https://app.shuftipro.com/process/kyc/hPbnp5FHJUlJADkdH3lcVZBiD2OP6rxcdEbzFBIEvtH7cucZA7DbUMZj10numa8C',
      ...
      return (
        <ShuftiPro
          ...
          asyncResponseCallback={response => {
            ...
            // if (
            //   !JSON.stringify(response).includes('verification_url') &&
            //   (JSON.stringify(createdPayload).includes('background_checks') ||
            //     JSON.stringify(createdPayload).includes('phone') ||
            //     (JSON.stringify(config).includes('"open_webview":true') &&
            //       response.event != 'request.unauthorized'))
            // ) {
            //   this.setState({
            //     switchBetweenServiceAndType: true,
            //     screenSelectServices: true,
